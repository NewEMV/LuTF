      ...
      <div className="min-h-screen">
        ...
        <footer className="py-12 border-t border-border text-center bg-card">
          ...
          <div className="flex justify-center gap-4 mt-6 mb-4">
            <a href="https://www.linkedin.com/in/luciana-telles-b9966817?utm_source=share_via&utm_content=profile&utm_medium=member_android" target="_blank" rel="noopener noreferrer"
            ...
            <a href="https://www.instagram.com/lucianatelles.psi?igsh=Y2NyYWFhY2t5aDd5" target="_blank" rel="noopener noreferrer"
